...
import acc_list from '@salesforce/apex/to_get_acc_rec.acc_list';

export default class Cpq_to_acc_id extends LightningElement {
   ...
   @wire(acc_list, {accname:'$accountName'})
